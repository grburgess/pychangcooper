...
from pychangcooper.scenarios.generic_cooling_acceleration import GenericCoolingAccelerationComponent
...
class SynchCoolAccel_ContinuousPLInjection(SynchrotronCoolingAccelerationComponent, ContinuousPowerlawInjection, PhotonEmitter, ChangCooper):
