...
def test_generic_cool_accel():
    ...
    generic_ca = CoolingAcceleration(
    ...
    fig = generic_ca.plot_evolution(skip=2, alpha=0.9, cmap="Set1", show_initial=True)


def test_synchrotron_cooling():

    synch_cool = SynchrotronCooling_ContinuousPLInjection(
        B=1e10,
        index=-3.5,
        gamma_injection=1e3,
        gamma_cool=500,
    ...
    synch_cool.plot_photons_and_electrons(skip=20, alpha=0.7, cmap="viridis")

    synch_cool.plot_final_emission()

    synch_cool = SynchrotronCooling_ImpulsivePLInjection(
        B=1e10,
        index=-3.5,
        gamma_injection=1e3,
        gamma_cool=500,
...
def test_synchrotron_cooling_acceleration():
    ...
    solver_mfc = SynchCoolAccel_ImpulsivePLInjection(
        n_grid_points=1000,
        B=5e9,
        gamma_injection=1e3,
        gamma_cool=1000.0,
    ...
    solver_mfc = SynchCoolAccel_ContinuousPLInjection(
        n_grid_points=1000,
        B=5e9,
        gamma_injection=1e3,
        gamma_cool=1000.0,
